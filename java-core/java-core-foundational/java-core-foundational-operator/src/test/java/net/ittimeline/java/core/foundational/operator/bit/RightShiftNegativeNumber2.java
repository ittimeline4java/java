 ...
 * @version 2025/4/7 14:14
 * @since Java21
 */
public class RightShiftNegativeNumber2 {
    public static void main(String[] args) {
        /*
            ...
            2.计算-8 >> 2（右移运算符的运算规则是用于将数据的二进制位向右移动，左边填充符号位，符号位是0填充0，符号位是1就填充1。
            右移n位在一定范围内就是除以2的n次方。）
            ...
            3.将补码换算成原码（查看运算结果看原码）
               ...
               =111111 1111 1111 1111 1111 1111 1111 01
                ...
                ②根据反码求原码：最高位不变，其他位取反
                反码：111111 1111 1111 1111 1111 1111 1111 01
                原码：100000 0000 0000 0000 0000 0000 0000 10
