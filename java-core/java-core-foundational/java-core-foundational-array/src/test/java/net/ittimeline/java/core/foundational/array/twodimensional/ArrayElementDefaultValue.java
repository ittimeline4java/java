...
public class ArrayElementDefaultValue {
    public static void main(String[] args) {
        ...
        //非空判断解决空指针异常
        if (null != intData2 && null != intData2[0] && intData2[0].length > 1) {
            System.out.println("intData2[0][1]= " + intData2[0][1]);
        } else {
            System.out.println("无法访问 intData2[0][1]，数组为空或长度不足。");
        }
        ...
        //非空判断解决空指针异常
        if (null != stringData2 && null != stringData2[0] && stringData2[0].length > 1) {
            System.out.println("stringData2[0][1]= " + stringData2[0][1]);
        } else {
            System.out.println("无法访问 stringData2[0][1]，数组为空或长度不足。");
        }
